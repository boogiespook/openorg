...
<nav class="navbar navbar-default" role="navigation">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.php"><img src="images/innovate.png">  Open Org Maturity Assessment</a>
		</div>
...
<form id="regForm" action="tmp.php">
  ...
  <div class="tab">
  <h3>Welcome to the Open Organization Maturity Assessment</h3>
