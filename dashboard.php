...
<body>
<?php
if ( (!isset($_GET['key'])) || ($_GET['key'] != "XXXXXXXXXXXXXXXXXXXXXXXXXX")) {
...
?>
       ...
       <div id="wrapper">
       <a class="w3-small w3-button w3-white w3-border w3-border-red w3-round-large" href="dashboard.php?key=XXXXXXXXXXXXXXXXXXXXXXX">Reset</a>
              <a target=_blank class="w3-small w3-button w3-green w3-border w3-border-teal w3-round-large" href="view.php?key=XXXXXXXXXXXXX">View Results</a>
      <header>
      <center>
