...
<center>
<img src="images/docHeader.jpg" alt="">
<br><br><br>

<p class="bigText">Open Organization Maturity Assessment</p>
<h2>Client Recommendations Document</h2>
<h3>Prepared for <?php echo $data_array['client']; ?></h3>
<h4>Date: <?php echo date('l jS \of F Y') ?></h4>

</center>
<p>Thank you very much for taking part in an Open Organization Maturity assessment.  This document provides a high level overview of the assessment and some possible next steps for <?php echo $data_array['client']; ?>.
</p>
